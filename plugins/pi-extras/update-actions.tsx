...
export type UpdateTarget = "models" | "plugins";
export const UpdateActions: ComponentType<{
  ...
  <div className="flex gap-2">
    ...
    <button type="button" disabled={updating !== null} className="rounded-md border border-input px-3 py-1.5 disabled:opacity-50" onClick={() => onUpdate("plugins")}>{updating === "plugins" ? "Updating..." : "Update plugins"}</button>
  </div>
);
